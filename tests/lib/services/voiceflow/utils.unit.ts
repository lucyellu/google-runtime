...
import {
  ...
  addVariables,
  mapSlots,
  transformDateTimeVariableToString,
...
describe('runtime manager utils unit tests', async () => {
  ...
  describe('transformDateTimeVariableToString', () => {
    ...
    // datetime
    expect(
      transformDateTimeVariableToString({ day: 1, month: 2, year: 2020, hours: 13, minutes: 15, seconds: 0, nanos: 0 })
    ).to.eql('1/2/2020 13:15');
    // time
    expect(transformDateTimeVariableToString({ hours: 13, minutes: 15, seconds: 0 } as any)).to.eql('13:15');
    // date
    expect(transformDateTimeVariableToString({ day: 1, month: 2, year: 2020, hours: 13 } as any)).to.eql(
      '1/2/2020 13:00'
    );
  });
  ...
  describe('mapSlots', () => {
    ...
    it('works', () => {
      ...
      const slots = {
        slotA: '1',
        slotB: 'value',
        slotC: { day: 1, month: 2, year: 2020, hours: 13, minutes: 15, seconds: 0, nanos: 0 },
      };
